...
% Datos de portada
\title{Implementación del algoritmo TRA-CLUS Mejorado para el análisis de tráfico \\Documentación Técnica}
\author{Álvaro González Delgado}
...
\include{./tex/F_Resultados_estudio}
\include{./tex/G_ODS}
